<x-template-layout>
    ...
    <div class="row" id="user-row">
        <div class="col-12">
            <p>A sua privacidade é importante para nós. É política do Print Moments respeitar a sua privacidade em
                relação a qualquer informação sua que possamos coletar no site <a href=https://printmoments.com.br>Print
                    Moments</a>, e outros sites que possuímos e operamos.</p>
            ...
            <h5>Política de Cookies Print Moments</h5>
            ...
            <ul>
                <li> Este site usa o Google Analytics, que é uma das soluções de análise mais difundidas e confiáveis
                    ...
                    que possamos continuar produzindo conteúdo atraente.
                </li>
            </ul>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Print Moments oferece no
                site e com caráter enunciativo, mas não limitativo:</p>
            <ul>
                <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
                <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou sobre cassinos, <a
                            href='https://ondeapostar.pt/'
                            style='color: inherit;font-weight: normal;text-decoration:none;'>apostas desportivas</a>
                    (ex.: <a href='https://ondeapostar.pt/review/betano/'
                             style='color: inherit;font-weight: normal;text-decoration:none;'>Betano</a>), jogos de
                    sorte e azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos
                    humanos;
                </li>
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Print Moments, de seus
