...
use App\Models\User;
use PhotoSale\API30\Merchant;
use PhotoSale\API30\Ecommerce\Environment;
use PhotoSale\API30\Ecommerce\CreditCard;
use PhotoSale\API30\Ecommerce\PhotoSaleEcommerce;
use PhotoSale\API30\Ecommerce\Request\PhotoSaleRequestException;
use PhotoSale\API30\Ecommerce\Sale;
use PhotoSale\API30\Ecommerce\Payment;
...
class PhotoSaleService
{
    ...
    public function createSale()
    {
        ...
        try {
            $sale = (new PhotoSaleEcommerce($this->merchant, $this->environment))->createSale($sale);
            $paymentId = $sale->getPayment()->getPaymentId();
            return $sale;
        } catch (PhotoSaleRequestException $e) {
            return $e->getPhotoSaleError();
        }
    }
    ...
    public function tokenizeCard(){
        ...
        try {
            $card = (new PhotoSaleEcommerce($this->merchant, $this->environment))->tokenizeCard($card);
